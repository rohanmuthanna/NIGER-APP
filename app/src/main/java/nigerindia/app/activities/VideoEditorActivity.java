...
import nigerindia.app.tools.AsyncTask;
...
public class VideoEditorActivity extends AppCompatActivity {
    ...
    private TextView tvLeft, tvRight,slowTV,flashTv,reverseTv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        slowTV = findViewById(R.id.slowTV);
        flashTv = findViewById(R.id.flashTV);
        reverseTv = findViewById(R.id.reverseTV);
        ...
        saveVideo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (input_video_uri != null) {
                    ...
                    Toast.makeText(VideoEditorActivity.this, "Please upload video", Toast.LENGTH_LONG).show();
            }
        });
...
*/
        ...
        if (resultCode == RESULT_OK) {
            ...
            if (data != null) {
                ...
                if (requestCode == WRITE_REQUEST_CODE) {
                    ...
                    new AsyncTask(VideoEditorActivity.this) {
                        @Override
    ...
    private void executeFfmpegCommand(String exe, String filePath) {
        ...
        ProgressDialog progressDialog = new ProgressDialog(VideoEditorActivity.this);
        ...
        FFmpegKit.executeAsync(exe, new ExecuteCallback() {
            ...
            public void apply(Session session) {
                ...
                VideoEditorActivity.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        if (returnCode.isSuccess()) {
                            ...
                            Toast.makeText(VideoEditorActivity.this, "Filter Applied", Toast.LENGTH_SHORT).show();
                        } else {
                            progressDialog.dismiss();
                            Log.d("TAG", session.getAllLogsAsString());
                            Toast.makeText(VideoEditorActivity.this, "Something Went Wrong!", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
